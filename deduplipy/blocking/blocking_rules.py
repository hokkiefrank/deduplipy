...
def last_three_letters_no_space(x):
    x = x.replace(' ', '')
    if len(x):
        return x[-3:]
    else:
...
def last_four_letters_no_space(x):
    x = x.replace(' ', '')
    if len(x):
        return x[-4:]
    else:
...
def last_five_letters_no_space(x):
    x = x.replace(' ', '')
    if len(x):
        return x[-5:]
    else:
